...
function formatDelta(pct: number | null | undefined): { text: string; positive: boolean | null } {
  if (pct === null || pct === undefined) return { text: '—', positive: null };
...
export function StatsCard({
  ...
  accentColor?: 'primary' | 'secondary' | 'tertiary' | 'rose' | 'amber';
}) {
