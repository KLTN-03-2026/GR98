      ...
      <Card className="max-w-md w-full border-dashed border-2">
        <CardContent className="flex flex-col items-center pt-10 pb-10 text-center space-y-4">
          ...
          <div className="space-y-2">
            <h1 className="text-2xl font-bold tracking-tight">Quản lý Nhà kho</h1>
            <p className="text-muted-foreground text-sm">
              Quản lý thông tin kho hàng được phân công, kiểm soát hàng hóa và theo dõi lưu kho. Đang trong quá trình hoàn thiện.
            </p>
          </div>
