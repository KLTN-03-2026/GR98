      ...
      <Card className="max-w-md w-full border-dashed border-2">
        <CardContent className="flex flex-col items-center pt-10 pb-10 text-center space-y-4">
          <div className="p-4 bg-orange-500/10 rounded-full">
            <Tags className="h-10 w-10 text-orange-600" />
          </div>
          <div className="space-y-2">
            <h1 className="text-2xl font-bold tracking-tight">Quản lý Danh mục</h1>
            <p className="text-muted-foreground text-sm">
              Quản lý danh mục sản phẩm nông sản, giúp phân loại và tối ưu tìm kiếm cho khách hàng. Đang trong quá trình hoàn thiện.
            </p>
          </div>
