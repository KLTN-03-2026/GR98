      ...
      <Card className="max-w-md w-full border-dashed border-2">
        <CardContent className="flex flex-col items-center pt-10 pb-10 text-center space-y-4">
          ...
          <div className="space-y-2">
            <h1 className="text-2xl font-bold tracking-tight">Cung & Cầu</h1>
            <p className="text-muted-foreground text-sm">
              Báo cáo so sánh sản lượng dự kiến, tồn kho thực tế và đơn hàng đang chờ xử lý. Đang trong quá trình hoàn thiện.
            </p>
          </div>
