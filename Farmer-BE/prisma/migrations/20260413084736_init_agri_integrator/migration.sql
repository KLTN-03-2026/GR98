...
-- AddForeignKey
ALTER TABLE "Contracts" ADD CONSTRAINT "Contracts_plotId_fkey" FOREIGN KEY ("plotId") REFERENCES "Plots"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Contracts" ADD CONSTRAINT "Contracts_priceBoardId_fkey" FOREIGN KEY ("priceBoardId") REFERENCES "PriceBoards"("id") ON DELETE SET NULL ON UPDATE CASCADE;
