      ...
      <Card className="max-w-md w-full border-dashed border-2">
        <CardContent className="flex flex-col items-center pt-10 pb-10 text-center space-y-4">
          ...
          <div className="space-y-2">
            <h1 className="text-2xl font-bold tracking-tight">Quản lý Nông dân</h1>
            <p className="text-muted-foreground text-sm">
              Quản lý danh sách nông dân, gán giám sát viên phụ trách và theo dõi tình hình canh tác. Đang trong quá trình hoàn thiện.
            </p>
          </div>
