                ...
                {users.map((user) => {
                  ...
                  return (
                    <div
                      ...
                      className={cn(
                        "rounded-2xl border border-l-4 bg-linear-to-br p-4 text-left shadow-xs transition hover:-translate-y-0.5 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 cursor-pointer",
                        tone.border,
                        tone.hover,
                        tone.bg,
                      )}
