      ...
      <Card className="max-w-md w-full border-dashed border-2">
        <CardContent className="flex flex-col items-center pt-10 pb-10 text-center space-y-4">
          ...
          <div className="space-y-2">
            <h1 className="text-2xl font-bold tracking-tight">Tổng quan Giám sát</h1>
            <p className="text-muted-foreground text-sm">
              Tổng quan công việc, diện tích lô đất đang canh tác và trạng thái báo cáo hàng ngày. Đang trong quá trình hoàn thiện.
            </p>
          </div>
