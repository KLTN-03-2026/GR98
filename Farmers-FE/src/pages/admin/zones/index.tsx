      ...
      <Card className="max-w-md w-full border-dashed border-2">
        <CardContent className="flex flex-col items-center pt-10 pb-10 text-center space-y-4">
          ...
          <div className="space-y-2">
            <h1 className="text-2xl font-bold tracking-tight">Quản lý Vùng</h1>
            <p className="text-muted-foreground text-sm">
              Quản lý phân vùng canh tác và khu vực sản xuất của hệ thống Agri-Integrator. Đang trong quá trình hoàn thiện.
            </p>
          </div>
