...
export default function ProductDetailPage() {
  ...
  const { data: relatedData } = useRelatedProducts(product?.id || '', 4);

  useEffect(() => {
    if (product?.minOrderKg) {
  ...
  if (isError || !product) {
    return (
      <div className="container mx-auto px-4 py-20 text-center pt-[140px]">
        <div className="text-6xl mb-6">🔍</div>
        <h2 className="text-2xl font-bold mb-2 text-slate-900">Không tìm thấy sản phẩm</h2>
        <p className="text-muted-foreground mb-8">Sản phẩm bạn đang tìm kiếm không tồn tại hoặc đã bị gỡ bỏ.</p>
